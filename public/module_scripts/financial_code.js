...
// alert('working');
	var xin_table = $('#xin_table').dataTable({
		...
		"ajax": {
            url : main_url+"financial/financial_list",
            type : 'GET'
        },
		"language": {
	...
	$('.view-modal-data').on('show.bs.modal', function (event) {
		...
		var modal = $(this);
	$.ajax({
		url : main_url+"financial/read_financial",
		type: "GET",
		data: 'jd=1&data=financial&field_id='+field_id,
...
$( document ).on( "click", ".delete", function() {
	...
	$('#delete_record').attr('action',main_url+'financial/delete_staff');
});
