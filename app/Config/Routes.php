...
$routes->get('erp/contract-type/', 'Types::contract_type', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']); /* Set Contract Type */
...
// financial code information
$routes->get('erp/financial-code/', 'Financial::index', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
...
$routes->get('erp/evaluation', 'Talent::evaluation', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']); /* Evaluation Route */
$routes->get('erp/work-plan', 'Workplan::index', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']); /* Workplan Route - Admin */
$routes->get('erp/workplan', 'Workplan::index', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']); /* Workplan Route - Staff */
$routes->get('erp/workplan-details/(:segment)', 'Workplan::workplan_details', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
// visitors
...
// Progress
// $routes->get('erp/financial-progress/', 'Financialprogress::index');
//$routes->get('erp/purchase-progress/', 'Financialprogress::transactions', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
