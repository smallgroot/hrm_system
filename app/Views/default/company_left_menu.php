...
<!-- 
      ...
      <li class="pc-item <?php if(!empty($arr_mod['evaluation_active']))echo $arr_mod['evaluation_active'];?>"> <a class="pc-link" href="<?= site_url('erp/evaluation');?>" >
        <?= lang('Dashboard.xin_hr_evaluation');?>
        </a> </li>
      <li class="pc-item <?php if(!empty($arr_mod['workplan_active']))echo $arr_mod['workplan_active'];?>"> <a class="pc-link" href="<?= site_url('erp/work-plan');?>" >
        <?= lang('Dashboard.xin_hr_workplan');?>
        </a> </li>
