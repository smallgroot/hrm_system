...
<div class="col-lg-3">
  <div class="card user-card user-card-1">
    ...
    <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab" role="tablist" aria-orientation="vertical"> <a class="nav-link list-group-item list-group-item-action active" id="account-settings-tab" data-toggle="pill" href="#account-settings" role="tab" aria-controls="account-settings" aria-selected="true"> <span class="f-w-500"><i class="feather icon-disc m-r-10 h5 "></i>
      ...
      <a class="nav-link list-group-item list-group-item-action" id="user-set-theme-tab" data-toggle="pill" href="#user-set-theme" role="tab" aria-controls="user-set-theme" aria-selected="false"> <span class="f-w-500"><i class="feather icon-layout m-r-10 h5 "></i>
      <?= lang('Main.xin_theme_settings');?>
      </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a>
      
      <a class="nav-link list-group-item list-group-item-action" id="fund_type_id_tab" data-toggle="pill" href="#fund_type_id" role="tab" aria-controls="fund_type_id" aria-selected="false"> <span class="f-w-500"><i class="feather icon-layout m-r-10 h5 "></i>
       Fund Type
       </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> 
      </a>
      <a class="nav-link list-group-item list-group-item-action" id="contract_modality_type_id_tab" data-toggle="pill" href="#contract_modality_type_id" role="tab" aria-controls="contract_modality_type_id" aria-selected="false"> <span class="f-w-500"><i class="feather icon-layout m-r-10 h5 "></i>
       Contract Modality
       </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> 
     </a>
    </div>
...
<!-- fund type start -->
<div class="tab-pane fade" id="fund_type_id" role="tabpanel" aria-labelledby="fund_type_id_tab">
<?php
...
<div class="col-md-4">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <?= form_open('erp/settings/add_fund_type', $attributes, $hidden);?>
      <div class="form-group">
        <label for="name">
          Fund Type
          <span class="text-danger">*</span> </label>
        <input type="text" class="form-control" name="name" placeholder="Fund Types">
      </div>
    </div>
    <div class="card-footer text-right">
      <button type="submit" class="btn btn-primary">
...
<div class="card user-profile-list">
  ...
  <div class="card-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="fund_type_xin_table" style="width:100%;">
        <thead>
          <tr>
...
<!-- fund type end -->
<!-- contract modality start -->
<div class="tab-pane fade" id="contract_modality_type_id" role="tabpanel" aria-labelledby="contract_modality_type_id_tab">
<?php
...
<div class="col-md-4">
  <div class="card">
    ...
    <div class="card-body">
      <?php $attributes = array('name' => 'add_goal_type', 'id' => 'contract_xin_form', 'autocomplete' => 'off');?>
      <?php $hidden = array('user_id' => 0);?>
      <?= form_open('erp/settings/add_contract_modality_type', $attributes, $hidden);?>
      <div class="form-group">
        <label for="name">
          Contract Modality
          <span class="text-danger">*</span> </label>
        <input type="text" class="form-control" name="name" placeholder="Contract Modality">
      </div>
    </div>
    <div class="card-footer text-right">
      <button type="submit" class="btn btn-primary">
...
<div class="card user-profile-list">
  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong>
    ...
    Contract Modality Types
    </span> </div>
  <div class="card-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="contract_type_xin_table" style="width:100%;">
        <thead>
          <tr>
            <th><i class="fas fa-braille"></i>
            Contract Modality Types</th>
            <th> <?= lang('Main.xin_created_at');?></th>
          </tr>
        </thead>
      </table>
