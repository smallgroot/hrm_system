      ...
      <div class="col-md-8">
        <div class="card mb-2">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <!-- <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="text-danger">*</span>
                  <select class="form-control" name="source_id" id="fundsource_id" data-plugin="" data-placeholder="Select Fund Source">
                    <option value=""></option>
                    <option value="">GoB</option>
                    <option value="">UNDP</option>
                  </select>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="text-danger">*</span>
                  <select class="form-control" name="modality_id" data-plugin="" data-placeholder="Select Employee Modality">
                    <option value=""></option>
                    <option value="">Government Attachment</option>
                    <option value="">Government Lien</option>
                    <option value="">Service Contract (UNDP)</option>
                    <option value="">Individual Contract (GoB)</option>
                    <option value="">Individual Contract (UNDP)</option>
                    <option value="">eZone</option>
                    <option value="">Young Professional</option>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="text-danger">*</span>
                  <select class="form-control" name="experiencelevel_id" data-plugin="" data-placeholder="Select Experience Level">
                    <option value=""></option>
                    <option value="">Junior</option>
                    <option value="">Mid</option>
                    <option value="">Senior</option>
                    <option value="">On Training</option>
                  </select>
                </div>
              </div>
            </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend"><span class="input-group-text">
                        <!--<?= $xin_system['default_currency'];?>--><!--BDT
                        </span></div>
            ...
            <input type="hidden" name="salay_type" value="1">
            </div>
          </div>
