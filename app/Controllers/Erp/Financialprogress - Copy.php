...
class Financialprogress extends BaseController {
	...
	public function expense_list() {
		...
		$SystemModel = new SystemModel();
		$TransactionsModel = new TransactionsModel();
		$TracefinancialModel = new TracefinancialModel();
		...
		$get_data = $TracefinancialModel->where('financial_progress_id',$usession['sup_user_id'])->orderBy('financial_progress_id', 'ASC')->findAll();
		...
		$data = array();
          ...
          foreach($get_data as $r) {
			...
			//edit
			$edit = '<span data-toggle="tooltip" data-placement="top" data-state="primary" title="'.lang('Main.xin_edit').'"><button type="button" class="btn icon-btn btn-sm btn-light-primary waves-effect waves-light" data-toggle="modal" data-target=".edit-modal-data" data-field_id="'. uencode($r['financial_progress_id']) . '"><i class="feather icon-edit"></i></button></span>';
			
			//edit
			$delete = '<span data-toggle="tooltip" data-placement="top" data-state="danger" title="'.lang('Main.xin_delete').'"><button type="button" class="btn icon-btn btn-sm btn-light-danger waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. uencode($r['financial_progress_id']) . '"><i class="feather icon-trash-2"></i></button></span>';
			...
			$combhr = $edit.$delete;
			$iaccount_name = '
			'.$iaccounts['financial_progress_id'].'
			<div class="overlay-edit">
				'.$combhr.'
			</div>';
